...
function moreContent(){
	var baconDiv = document.getElementById("more");
	baconDiv.innerHTML = bacon;
}
...
function zoom(){
	var zoom = document.getElementById("biggie");
	zoom.style="font-size:150%";
...
var menuItems = ["Big Mac","Sundae","Fries"];
function valueMenu(){
...
function redFace(){
	var red = document.getElementById("drink");
	red.style.color = "red";
...
document.getElementById("Benjamin").addEventListener("click",event);
